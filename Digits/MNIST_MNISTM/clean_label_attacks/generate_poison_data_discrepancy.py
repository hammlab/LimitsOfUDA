...
for epoch in range(EPOCHS):
    ...
    if epoch % 20 == 0:
        ...
        print([eval_accuracy_main_cdan(x_target_point, y_target_point_incorrect_label, shared[i], main_classifier_1[i])  for i in range(NUM_MODELS)])
        print([eval_accuracy_main_cdan(x_target_point, y_target_point, shared[i], main_classifier_1[i]) for i in range(NUM_MODELS)])
