...
from utils import eval_accuracy_main_cdan, eval_accuracy_dc
...
for epoch in range(EPOCHS):
    ...
    if epoch % 20 == 0:  
        ...
        print([eval_accuracy_main_cdan(x_target_test, y_target_test_incorrect_label, shared_1[i], main_classifier[i])  for i in range(NUM_MODELS)])
        print([eval_accuracy_main_cdan(x_target_test, y_target_test, shared_1[i], main_classifier[i]) for i in range(NUM_MODELS)])
